...
public class TickCounter extends LinearOpMode {
    ...
    private DcMotorEx leftOuttake,rightOuttake;
    @Override
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            int leftOuttakePausePosition = leftOuttake.getCurrentPosition();
            int rightOuttakePausePosition = rightOuttake.getCurrentPosition();
