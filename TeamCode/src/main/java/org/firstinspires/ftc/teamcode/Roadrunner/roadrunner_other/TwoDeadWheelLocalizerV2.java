...
@Config
public final class TwoDeadWheelLocalizerV2 implements Localizer {
    ...
    public TwoDeadWheelLocalizerV2(HardwareMap hardwareMap, IMU imu, double inPerTick, Pose2d initialPose) {
