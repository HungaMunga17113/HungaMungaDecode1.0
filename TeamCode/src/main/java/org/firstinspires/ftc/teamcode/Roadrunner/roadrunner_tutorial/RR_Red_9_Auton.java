...
@Config
@Autonomous(name = "RR Red 9 Auton")
public class RR_Red_9_Auton extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action intake1path = drive.actionBuilder(new Pose2d(-45, 45, Math.toRadians(127)))
                ...
                .lineToYLinearHeading(53.5, Math.toRadians(60))
                .lineToYSplineHeading(42.67, Math.toRadians(120))
                .build();

        Action shoot2path = drive.actionBuilder(new Pose2d(-14.5, 45, Math.toRadians(90)))
        ...
        Action shoot3path = drive.actionBuilder(new Pose2d(9.25, 45, Math.toRadians(115)))
                .strafeToLinearHeading(new Vector2d(-45,45),Math.toRadians(125))
                .stopAndAdd(intake.idle())
                .waitSeconds(0.25)
                .stopAndAdd(outtake.shoot())
