...
public class RR_Red_Auton extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action intake3path = drive.actionBuilder(new Pose2d(-45, 45, Math.toRadians(125)))
                .strafeToLinearHeading(new Vector2d(33,17.75),Math.toRadians(90))
                .stopAndAdd(intake.in())
                .strafeToConstantHeading(new Vector2d(31.5,62),new TranslationalVelConstraint(20))
                .build();

        Action shoot4path = drive.actionBuilder(new Pose2d(31.5, 62, Math.toRadians(90)))
