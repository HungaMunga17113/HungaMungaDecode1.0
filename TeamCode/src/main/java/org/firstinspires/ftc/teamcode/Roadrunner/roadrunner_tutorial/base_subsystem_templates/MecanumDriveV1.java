...
@Config
public final class MecanumDriveV1 {
    ...
    public class DriveLocalizer implements Localizer {
        ...
        public DriveLocalizer(Pose2d pose) {
            leftFront = new OverflowEncoder(new RawEncoder(MecanumDriveV1.this.leftFront));
            leftBack = new OverflowEncoder(new RawEncoder(MecanumDriveV1.this.leftBack));
            rightBack = new OverflowEncoder(new RawEncoder(MecanumDriveV1.this.rightBack));
            rightFront = new OverflowEncoder(new RawEncoder(MecanumDriveV1.this.rightFront));
    ...
    public MecanumDriveV1(HardwareMap hardwareMap, Pose2d pose) {
